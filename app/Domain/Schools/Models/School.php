...
class School extends Model
{
        ...
        public function setThemeConfig(array $config): void
    {
        ...
        if (isset($config['light']['colorSecondary'])) {
            $this->secondary_color = $config['light']['colorSecondary'];
        }
        if (isset($config['light']['colorAccent'])) {
            $this->accent_color = $config['light']['colorAccent'];
        }
        // Note: logo_path and favicon_path are not part of the theme config for now
     ...
     */
    protected function getDefaultThemeConfig(): array { return [ 
                // Base
