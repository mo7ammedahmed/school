...
export default function SectionsCreate({ gradeLevels, academicYears }: { gradeLevels: { id: number; name: string }[]; academicYears: { id: number; name: string }[] }) {
    return (
        <AppShell
            title="Add Section"
            breadcrumbs={[
        ...
        >
            ...
            <Card>
                ...
                <CardContent>
                    <form className="space-y-6" method="POST" action="/sections">
