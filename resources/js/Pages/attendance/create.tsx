    ...
    return (
        ...
        >
            ...
            <Card>
                ...
                <CardContent>
                    <form className="space-y-6" method="POST" action="/attendance">
                        <div className="grid gap-6 md:grid-cols-2">
                            <div className="md:col-span-2">
                                <Label htmlFor="attendance_session_id">Attendance Session</Label>
                                <select id="attendance_session_id" name="attendance_session_id" className="input" required>
                            ...
                            <div>
                                ...
                                <select id="status" name="status" className="input" required defaultValue="present">
