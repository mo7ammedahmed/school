...
export default function ExamResultsCreate({ exams, students }: { exams: { id: number; name: string }[]; students: { id: number; first_name: string; last_name: string }[] }) {
    return (
        <AppShell
        ...
        >
            ...
            <Card>
                ...
                <CardContent>
                    <form className="space-y-6" method="POST" action="/exam-results">
                        <div className="grid gap-6 md:grid-cols-2">
                            <div>
                                <Label htmlFor="exam_id">Exam</Label>
                                <select id="exam_id" name="exam_id" className="input" required>
